...
public class ClientForDeepClone {
	...
	public static void main(String[] args) {
		EmailForDeepClone email = new EmailForDeepClone("请参加会议","请与今天12:30到二会议室参加会议...");
		PersonForDeepClone person1 =  new PersonForDeepClone("张三",email);
		
		PersonForDeepClone person2 =  CloneUtils.clone(person1);
        person2.setName("李四");
        PersonForDeepClone person3 =  CloneUtils.clone(person1);
        person3.setName("王五");
